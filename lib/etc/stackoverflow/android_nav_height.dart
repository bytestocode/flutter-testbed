...
class AndroidNavHeight extends StatefulWidget {
  @override
  State<AndroidNavHeight> createState() => _AndroidNavHeightState();
}

class _AndroidNavHeightState extends State<AndroidNavHeight> {
  int selectedIndex = 0;
